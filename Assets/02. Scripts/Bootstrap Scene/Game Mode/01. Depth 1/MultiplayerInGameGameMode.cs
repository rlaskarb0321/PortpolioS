...
public class MultiplayerInGameGameMode : GameModeBase
{
    public override async UniTask OnSceneActivated()
    {
        Debug.Log($"[MultiplayerInGameGameMode] OnSceneActivated");
    ...
    {
        Debug.Log($"[MultiplayerInGameGameMode] OnSSceneCompletelyLoaded");
    }
}
